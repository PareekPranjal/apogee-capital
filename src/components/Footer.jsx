...
const footerLinks = {
  Services: ["Business Planning", "Growth Capital", "M&A Advisory", "Debt Syndication", "Strategic Consulting"],
        ...
        <Reveal delay={0.2}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-20">
            {Object.entries(footerLinks).map(([title, links]) => (
              <div key={title}>
                <h4 className="text-[10px] font-semibold tracking-[0.25em] uppercase text-white/20 mb-6">{title}</h4>
